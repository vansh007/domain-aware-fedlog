...
seeds (Table~\ref{tab:3domain}). Three results stand out. First, the H1 collapse-and-recovery on HDFS is
...
over three seeds under both input encodings (Table~\ref{tab:arch}). The map holds: under
